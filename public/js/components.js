...
function listCelular(data) {
  ...
  data.results.forEach(function(element) {
    ...
    containerProduct.append(`<a href="#/id=?${categoryId}-${titleChain}" class="col-12 col-md-3 text-center box-celphone selection" data-img="${img}" data-title="${title}" data-price="${price}" data-available="${availableQuantity}" data-sold="${soldQuantity}">  
...
// Crea un contenedor del producto seleccionado
function celular() {
